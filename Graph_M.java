...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("CSS AirPort");
			g.addVertex("Amausi");
			g.addVertex("Transport Nagar");
			g.addVertex("Krishna Nagar");
			g.addVertex("Sringar Nagar");
			g.addVertex("AlamBagh");
			g.addVertex("AlamBagh Bus Station");
			g.addVertex("Mawaiya");
			g.addVertex("DurgaPuri");
			g.addVertex("CharBagh");
			g.addVertex("HussianGanj");
			g.addVertex("Sachvalaya");
			g.addVertex("HazartGanj");
			g.addVertex("KD Singh Station");
			g.addVertex("Vishwavidyalay");
			g.addVertex("IT College");
			g.addVertex("Badhshah Nagar");
			g.addVertex("Lekhraj Market");
			g.addVertex("Bhootnath Market");
			g.addVertex("IndraNagar");
			
			g.addEdge("CSS AirPort", "Amausi", 8);
			g.addEdge("Amausi", "Transport Nagar", 10);
			g.addEdge("Transport Nagar", "Krishna Nagar", 8);
			g.addEdge("Krishna Nagar", "Sringar Nagar", 6);
			g.addEdge("Sringar Nagar", "AlamBagh", 9);
			g.addEdge("AlamBagh", "AlamBagh Bus Station", 7);
			g.addEdge("AlamBagh Bus Station", "Mawaiya", 6);
			g.addEdge("HazartGanj", "KD Singh Station", 15);
			g.addEdge("KD Singh Station", "Vishwavidyalay", 6);
			g.addEdge("Vishwavidyalay", "IT College", 7);
			g.addEdge("IT College", "Badhshah Nagar", 1);
			g.addEdge("Badhshah Nagar", "Lekhraj Market", 2);
			g.addEdge("Lekhraj Market", "CharBagh", 5);
			g.addEdge("Bhootnath Market", "Mawaiya", 2);
			g.addEdge("DurgaPuri", "HussianGanj", 7);
			g.addEdge("CharBagh", "Sachvalaya", 8);
			g.addEdge("Mawaiya", "IndraNagar", 2);
			g.addEdge("IndraNagar", "CharBagh", 2);
			g.addEdge("HussianGanj", "CSS AirPort", 3);
		}
